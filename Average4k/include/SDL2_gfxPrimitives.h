...
#  define SDL2_GFXPRIMITIVES_SCOPE extern
	...
	SDL2_GFXPRIMITIVES_SCOPE int hlineRGBASize(SDL_Renderer* renderer, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Sint16 borderSize);
	/* Vertical line */
	...
	SDL2_GFXPRIMITIVES_SCOPE int vlineRGBASize(SDL_Renderer* renderer, Sint16 x, Sint16 y1, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Sint16 size);
	...
	SDL2_GFXPRIMITIVES_SCOPE int roundedRectangleRGBA(SDL_Renderer * renderer, Sint16 x1, Sint16 y1,
		Sint16 x2, Sint16 y2, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Sint16 borderSize);
